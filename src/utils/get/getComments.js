 ...
 */
export const getComments = async (url, proxy, commentLimit) => new Promise(async (resolve) => {
...
const requestComments = async (id, commentLimit, proxy) => {
    const { data } = await Axios(_tiktokGetComments(_getCommentsParams(id, commentLimit)), {
        method: "GET",
        headers: {
